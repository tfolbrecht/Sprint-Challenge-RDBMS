...
The relation database system is the table based datastore system.

SQL is a query language for relational databases.

2. Why do tables need a `primary key`?

A primary key is a unique key representing a specific row.

3. What is the name given to a table column that 
references the primary key on another table.
